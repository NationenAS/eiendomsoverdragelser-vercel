function clean(data) {
    ...
    data.Hits.forEach(d => {
        ...
        let xy = d.Property.StreetAddress.Coordinate ? [d.Property.StreetAddress.Coordinate.Latitude.toFixed(5), d.Property.StreetAddress.Coordinate.Longitude.toFixed(5)] : null
